<template>
    <div class="order">
        <div class="box">
               <div class="swrap">
                <div class='remiad'>订单中包含海外购商品，海关要求必须提供真实姓名和身份证号进行实名认证，且实名人与支付人必须一致，错误信息可能导致无法清关，平台保证您的信息安全，绝不对外泄露！</div>
               <div class="address">
                   <dl>
                       <dd>
                           <p class="name">
 ...
 <cover-image class="blue-red" src="/static/images/orderdetail.png"/>       
            ...
            <div class="two">
                <dl class="center">
                    <dd>
                       <cover-image src="https://jnup.oss-cn-beijing.aliyuncs.com/product/5ff2e16ecbe2d3582065d1c89e50d231.jpg"/>
                    </dd>
                        <dt>
            ...
            <div class="three">
                <span>订单总计</span>
                <div><span>￥</span><span class="money">99</span></div>
            </div>
            <div class="three">
                <span>优惠券</span>
            ...
            <div class="three">
                <span><cover-image src="/static/images/7.png"/><span class="sps">微信支付</span></span>
